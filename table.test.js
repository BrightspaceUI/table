...
registerCSSTest('cssChrome', browsers.chrome);
registerTest('chrome', browsers.chrome);

registerCSSTest('cssChromeMac', browsers.chromeMac);
registerCSSTest('cssChromeWindows', browsers.chromeWindows);
registerTest('ie11Windows', browsers.ie11Windows);
registerCSSTest('cssSafariMac', browsers.safariMac);
registerTest('safariMac', browsers.safariMac);
registerTest('chromeMac', browsers.chromeMac);
registerTest('chromeWindows', browsers.chromeWindows);
registerTest('edgeWindows', browsers.edgeWindows);
registerCSSTest('cssedgeWindows', browsers.edgeWindows);
...
function registerTest(browserName, browser) {
	var browsers = {};
...
function registerCSSTest(browserName, browser) {
	var cssBrowsers = {};
	cssBrowsers[browserName] = browser;
